...
- [ ] G1: the measured 43U matched-code percentage reaches 99 percent
  ...
  EVIDENCE: 57.398243 percent, 1719176 / 2995172 code bytes, 8728 / 12563 functions (2026-09-19); threshold not reached
...
- [x] G2: the complete 43U build succeeds after each matching change
  ...
  EVIDENCE: full 43U build passed after EGG::ArcPlayer::startSound match (2026-09-19)
