...
- [ ] G1: the measured 43U matched-code percentage reaches 99 percent
  ...
  EVIDENCE: 57.407190 percent, 1719444 / 2995172 code bytes, 8730 / 12563 functions (2026-09-19); threshold not reached
...
- [x] G2: the complete 43U build succeeds after each matching change
  ...
  EVIDENCE: full 43U build passed after snd::System::startSE and SoundHandle::GetId matches (2026-09-19)
